...
declare class NwcClient {
    ...
    listInvoices(p?: ListInvoicesParams): Promise<ListInvoicesResult>;
    listOffers(p?: ListOffersParams): Promise<ListOffersResult>;
    disableOffer(p: DisableOfferParams): Promise<void>;
    listAddresses(p?: ListAddressesParams): Promise<ListAddressesResult>;
    /**
